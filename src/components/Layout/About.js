    ...
    <React.Fragment>
      <div id="about" className={classes["about-wrapper-row"]}>
        <div className={classes["about-column"]}>
          ...
          <p className={classes["about-text-container"]}>I am a web developer with two years experience building and creating responsive and high quality applications using React and Ruby on Rails. I have obtained a solid foundation and understanding of web development while attending and completing a coding bootcamp. Thereafter the bootcamp, I was an intern software developer for a consultant company, Coding Zeal. During this time I gained experience and knowledge in working in an Agile methodology environment. I know am freelance web developer with hands on experience in building and designing web apps. I have passion to keep growing as a developer and taking on new challanges.</p>
        </div>
        <div className={classes["about-column"]}>
